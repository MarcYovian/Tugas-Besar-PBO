...
public class Exited_Product extends javax.swing.JPanel {

    private editProduct data;
    
    public Exited_Product() {
        initComponents();
        
        cbIdStack.setEnabled(false);
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (idRak <= 0 || idPelanggan <= 0 || date.equals("") || status.equals("")) {
                        ...
                        //Switch panel 2
                        Exited_Product2 edit = new Exited_Product2();
                        Main main = (Main) SwingUtilities.getWindowAncestor(Exited_Product.this);
                        main.setForm(edit);
                    }
    ...
    private void displayIdPelanggan(){
        ...
        try {
            ...
            model.removeAllElements();
            rs = db.getData("SELECT * FROM pelanggan WHERE isSupplier = 0");
            while (rs.next()) {                
